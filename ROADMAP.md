# ROADMAP — blackroad.me

> Product roadmap for BlackRoad Me
...
- [ ] Deploy index.html to blackroad.me
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroad.me with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: RoadAuth, RoadVault, Digital Identity, SSO
...
**Milestone**: First paying customer through blackroad.me.
...
**Milestone**: blackroad.me is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: identity | Products: RoadAuth, RoadVault, Digital Identity, SSO*
